...
const HeaderText = ({ title, paragraph, isHero }: HeaderProps) => {
  return (
    <div
      className={`${isHero ? "px-0 pt-large md:pt-xxlarge" : "mt-large"} align-center flex flex-col items-center gap-regular`}
    >
      <h1
      ...
      <p className="text-center text-darkSecondary dark:text-lightSecondary md:text-lg lg:w-4/6">
        {paragraph}
      </p>
      {isHero ? (
