...
export async function POST(req: Request, res: Response) {
  ...
  const result = await streamText({
    ...
    prompt: `Create a cover letter based on this job posting. The name of the recruiter is ${recruiter}, add the name in the initial salutation. State that i have ${yearsOfExperience} years of experience in the field.
