...
const HeaderText = ({ title, paragraph, isHero }: HeaderProps) => {
  return (
    ...
    >
      <h1
        className={`${isHero ? "3xl:text-9xl h-full bg-gradient-to-r from-dark via-dark to-gray-500 bg-clip-text text-5xl text-transparent dark:from-light dark:via-light dark:to-gray-400 md:text-7xl lg:text-8xl" : "text-6xl"} text-center font-bold`}
      >
        {title}
      </h1>
      <p
